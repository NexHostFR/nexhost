<div class="container my-5 py-5 border text-white rounded-3">
    <div class="row align-items-center">
        <div class="col-md-7">
            ...
            {{ form_start(form_newsletter, {'action': path('app_newsletter'),'attr': {'class': 'd-flex flex-column'}}) }}
                <div class="input-group">
                    {{ form_widget(form_newsletter.email, {'attr': {'placeholder': 'Entrez votre meilleure adresse mail', 'class': 'form-control rounded-end-0'}}) }}
                    <button type="submit" class="btn btn-dark text-white rounded-start-0">Je m'abonne !</button>
                </div>
                <div class="form-check">
                    {{ form_widget(form_newsletter.consent, {'attr': {'class': 'form-check-input'}}) }}
