    ...
    <div class="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <div class="benefit-item">
                ...
                <p class="text-gray-700 mt-2">Nous encourageons le développement de tes compétences et de ta créativité. Que ce soit à travers des formations ou des projets ambitieux, NxHost est l'endroit idéal pour grandir tout en restant toi-même.</p>
            </div>
        </div>
    </div>
