<footer class="pt-5 mt-5 bg-gray-100">
    <div class="container mx-auto">
        <div class="border-b pb-5">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://www.facebook.com/NxHostFR" class="text-gray-600 hover:text-blue-800" target="_blank">
                        <i class="bi bi-facebook"></i>
                    </a>
                    <a href="https://www.linkedin.com/company/nxhostfr/" class="text-gray-600 hover:text-blue-600" target="_blank">
                        <i class="bi bi-linkedin"></i>
                    </a>
                    <a href="https://www.instagram.com/NxHostfr/" class="text-gray-600 hover:text-pink-500" target="_blank">
        ...
        <div class="pt-5 flex space-x-8">
            <div>
                <h3 class="text-lg font-semibold text-gray-800">NxHost</h3>
