        ...
        <div class="pt-3 d-flex flex-row">
            <div class="col">
                ...
                <ul class="list-unstyled">
                    <li><a href="/a-propos">À propos de NexHost</a></li>
                    <li><a href="/a-propos/equipe">L'équipe</a></li>
                    <li><a href="/a-propos/carriere">NexHost recrute</a></li>
                    <li><a href="https://news.nexhost.fr">Les news de NexHost</a></li>
            ...
            <div class="col">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="https://faq.nexhost.fr" target="_blank">FAQ</a></li>
                    <li><a href="/sales">Contact commercial</a></li>
                    <li><a target="_blank" href="https://status.nexhost.fr">Statut des services</a></li>
                </ul>
            </div>
        </div>
